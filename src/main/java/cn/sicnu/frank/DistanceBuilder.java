...
public class DistanceBuilder {
    ...
    public static LinkedHashSet<List<Station>> lineSet = new LinkedHashSet<List<Station>>();//所有集合
    ...
    public static void createlineData(){
        lineData = new HashMap<String, List<Station>>();
    ...
    public static void readSubway() {
        ...
        try {
            ...
            String line = null;
            //String如：天府广场:春熙路   double为距离，如：1
            //默认起始为1号线
            String lineName = "1";
